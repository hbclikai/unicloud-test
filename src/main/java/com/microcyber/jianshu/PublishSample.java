package com.microcyber.jianshu;
...
/**
 * 发布端
 * 来源: https://www.jianshu.com/p/65e1748a930c
 */
public class PublishSample {
    private static String topic = "topic1";
    private static String content = "来自paho.client的消息"+System.currentTimeMillis();
    private static int qos = 1;
    private static String broker = "tcp://192.168.2.186:1883";
    private static String userName = "test";
    private static String password = "123456";
    private static String clientId = "pahoPubClient1";
